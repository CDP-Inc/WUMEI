...
namespace WUMEI.Controllers
{
    ...
    public class WicEbaAccountController : Controller
    {
        ...
        public IActionResult UpdateEba(
            [FromBody]UpdateEba eba
        )
        {
        ...
        /// <summary>
        /// The Get EBA Using Card Number function is an optional function that uses a message based system interface to provide the Card number to identify the WIC MIS account ID and then display the household record in the WIC MIS.
        /// </summary>
        /// <param name="eba">Details of the EBA to be returned.</param>
        /// <response code="200">Returns the updated message header and EBA details.</response>   
        [HttpGet]
