...
namespace WUMEI.Controllers.V2020
{
    ...
    public class BatchFileController : Controller
    {
        ...
        /// <summary>
        /// The Report WIC Vendor Readiness function is an optional function that uses a batch system interface to
        /// indicate when a WIC Vendor is operational and ready to accept transactions
        /// </summary>
        /// <remarks>
        /// The batch name is WIC Vendor Readiness File.
        /// </remarks>
        /// <param name="vendor"></param>
        /// <returns></returns>
        [HttpPost]
        ...
        [Produces("application/json")]
        [ProducesResponseType(typeof(BatchConfirmationFile), 200)]
        public IActionResult ReportWicVendorReadiness(
            [FromBody]ReportWicVendorReadiness vendor
        )
        {
            return Ok(new BatchConfirmationFile());
        }
