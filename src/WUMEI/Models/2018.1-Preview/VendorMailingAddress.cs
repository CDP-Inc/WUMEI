...
{
    /// <summary>
    /// Represents a vendor's mailing address.
    /// </summary>
    public class VendorMailingAddress
    {
        ...
        /// <summary>
        /// Gets or sets the sub-element of address data elements and a constructed data element
        /// including the Address ZIP code, primary and the Address ZIP code, extended for the address specified.
        /// </summary>
        [Required]
